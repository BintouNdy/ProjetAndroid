...
public class Memory extends SubActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setView(R.layout.activity_memory);

        FloatingActionButton fab = findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "Jeu à 2 joueurs, à vous de retrouver les images identiques", Snackbar.LENGTH_LONG)
